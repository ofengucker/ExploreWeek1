...
x <- tabProj$datetime
plot1 <- plot(x,y, type="n", ylab = "Global Active Power", xlab = NA, cex.axis = 0.9, cex.lab = 0.9)
lines(x, y, type="l")

## Plot 2 - top right
y <- tabProj$Voltage
x <- tabProj$datetime
plot3 <- plot(x, y, type ="n", ylab = "Voltage", xlab = "datetime",cex.axis = 0.9, cex.lab = 0.9)
lines(x,y,type="l")
...
plot2 <- plot(x,y1, type = "n",ylab = "Energy sub metering", xlab = NA,ylim=c(0,max(y1)), cex.axis = 0.9, cex.lab = 0.9)
lines(x,y1, type="l")
...
## Plot 4 - bottom right
y <- tabProj$Global_reactive_power
plot(x,y,type="n", xlab = "datetime", ylab = names(tabProj)[4],cex.axis = 0.9, cex.lab = 0.9)
lines(x, y, type ="l")
